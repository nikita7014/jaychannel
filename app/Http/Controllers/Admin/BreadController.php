...
class BreadController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.dashboard.form.index', ['forms' => Form::all()]);
    }
    ...
    {
        return view('admin.dashboard.form.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->has('marker') && $request->input('marker') === 'selectModel'){
            ...
            if(empty($model)){
                ...
                return view('admin.dashboard.form.create2', [
    ...
    {
        return view('admin.dashboard.form.show', [
            'form' => Form::find($id),
    ...
    public function edit($id)
    {
        $formService = new FormService();
        $rolesService = new RolesService();
        return view('admin.dashboard.form.edit', [
            'form' => Form::find($id),
            'formFields' => FormField::where('form_id', '=', $id)->get(),
            'options' => $formService->getFormOptions(),
            'roles'   => $rolesService->get(),
    ...
    public function destroy($id, Request $request)
    {
        ...
        if($request->has('marker')){
            ...
            return view('admin.dashboard.form.delete', ['id' => $id, 'formName' => $form->name]);
        }
    }
}
