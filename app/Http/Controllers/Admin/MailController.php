...
class MailController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.dashboard.email.index', ['emailTemplates' => $emailTemplates]);
    }
    ...
    {
        return view('admin.dashboard.email.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.dashboard.email.show', [ 'template' => $template ]);
    }
    ...
    {
        $template = EmailTemplate::find($id);
        return view('admin.dashboard.email.edit', [ 'template' => $template ]);
    }
    ...
    public function prepareSend($id){
        $template = EmailTemplate::find($id);
        return view('admin.dashboard.email.send', [ 'template' => $template ]);
    }
