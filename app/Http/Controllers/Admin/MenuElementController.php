...
class MenuElementController extends Controller
{
    ...
    public function index(Request $request){
        ...
        return view('admin.dashboard.editmenu.index', array(
    ...
    public function create(){
        return view('admin.dashboard.editmenu.create',[
            'roles'    => RolesService::get(),
            'menulist' => Menulist::all(),
        ]);
    }
    ...
    public function edit(Request $request){
        ...
        return view('admin.dashboard.editmenu.edit',[
            'roles'    => RolesService::get(),
            'menulist' => Menulist::all(),
    ...
    public function show(Request $request){
        ...
        return view('admin.dashboard.editmenu.show',[
            'menulist' => Menulist::all(),
    ...
    public function delete(Request $request){
        ...
        return view('admin.dashboard.shared.universal-info');
    }
