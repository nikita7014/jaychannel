...
class NotesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.dashboard.notes.notesList', ['notes' => $notes]);
    }
    ...
    {
        $statuses = Status::all();
        return view('admin.dashboard.notes.create', [ 'statuses' => $statuses ]);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.dashboard.notes.noteShow', [ 'note' => $note ]);
    }
    ...
    public function edit($id)
    {
        $note = Notes::find($id);
        $statuses = Status::all();
        return view('admin.dashboard.notes.edit', [ 'statuses' => $statuses, 'note' => $note ]);
    }
