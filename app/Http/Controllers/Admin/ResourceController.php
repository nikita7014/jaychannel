...
class ResourceController extends Controller
{
    ...
    public function index($table, Request $request)
    {
        ...
        return view('admin.dashboard.resource.index', [
            'form' => $form,
    ...
    public function create($table, Request $request)
    {
        ...
        if($form->add == 1){
            ...
            return view('admin.dashboard.resource.create', [
                'form' => $form,
                'columns' => $columns,
    ...
    public function show($table, $id, Request $request)
    {
        ...
        if($form->read == 1){
            $resourceService = new ResourceService();
            return view('admin.dashboard.resource.show', [
                'form' => $form,
    ...
    public function edit($table, $id)
    {
        ...
        if($form->edit == 1){
            $resourceService = new ResourceService();
            $formService = new FormService();
            return view('admin.dashboard.resource.edit', [
                'form' => $form,
    ...
    public function destroy($table, Request $request, $id)
    {
        ...
        if($form->delete == 1){
            if($request->has('marker')){
                ...
                return view('admin.dashboard.resource.delete', ['table' => $table, 'id' => $id, 'formName' => $form->name]);
            }
        }else{
            abort('401');
        }
