...
class CourseController extends Controller
{
    ...
    public function create_course(){
        ...
        if(!empty($user)){
            ...
            return view('vendor.course_create', ['userInfo' => $user_info, 'vendor_logo_upload_path' => $user->get_vendor_logo_upload_path()]);        
        }
        else{
            return redirect()->route('home');
        }
    ...
    public function edit_course($id, Request $request){
        ...
        if(!empty($user)){
            ...
            return view('vendor.course_edit', ['userInfo' => $user_info, 'course_data' => $course_data, 'vendor_logo_upload_path' => $user->get_vendor_logo_upload_path()]);        
        }
        else{
            return redirect()->route('home');
        }
    ...
    public function store(Request $request)
    {
        ...
        $course->content_type = $postData['fld_content_type'];
