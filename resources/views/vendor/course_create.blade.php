               ...
               <form action="{{ route('show_signinvendor_savenewcourse') }}" name="frmCreateCourse" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row ">
                     ...
                     <div class="col-lg-8 col-12">
                        <input type="text" class="form-control custom-file float-right" name="fld_title" placeholder="" required />
                     </div>
                  </div>
                  <br>
                  <div class="row ">
                     ...
                     <div class="col-lg-3 col-12">
                        ...
                        <input type="date" class="form-control custom-file float-right" name="fld_start_date" placeholder="" required />
                     </div>
                     ...
                     <div class="col-lg-3 col-12">
                        ...
                        <input type="date" class="form-control custom-file float-right" name="fld_end_date" placeholder="" required />
                     </div>
                     <!--<div class="col-lg-2 col-12">
                        <select class="form-control select inline " id="days">
                           <option>12</option>
                  ...
                  <div class="row ">
                     ...
                     <div class="col-lg-3 col-12">
                        ...
                        <input type="time" class="form-control custom-file float-right" name="fld_start_time" placeholder="" required />
                     </div>
                     <!--<div class="col-lg-2 col-12">
                        <select class="form-control select inline " id="days">
                           <option>AM</option>
                     ...
                     <div class="col-lg-3 col-12">
                        ...
                        <input type="time" class="form-control custom-file float-right" name="fld_end_time" placeholder="" required />
                     </div>
                     <div class="col-lg-2 col-12">
                        <!--<select class="form-control select inline " id="days">
                           <option>AM</option>
                  ...
                  <div class="row">
                     <div class="col-lg-1 col-12">
                        ...
                        <input type="checkbox" class="form-control" name="fld_day_monday" value="1" />
                     ...
                     <div class="col-lg-1 col-12">
                        <label class="containercheckmark">
                        <input type="checkbox" class="form-control" name="fld_day_tuesday" value="1" />
                        <span class="checkmark"></span>
                        <span>Tu</span>
                        </label>
                     </div>
                     <div class="col-lg-1 col-12">
                        <label class="containercheckmark">
                        <input type="checkbox" class="form-control" name="fld_day_wednesday" value="1" />
                        <span class="checkmark"></span>
                        <span>W</span>
                        </label>
                     </div>
                     <div class="col-lg-1 col-12">
                        <label class="containercheckmark">
                        <input type="checkbox" class="form-control" name="fld_day_thursday" value="1" />
                        <span class="checkmark"></span>
                        <span>Th</span>
                        </label>
                     </div>
                     <div class="col-lg-1 col-12">
                        <label class="containercheckmark">
                        <input type="checkbox" class="form-control" name="fld_day_friday" value="1" />
                        <span class="checkmark"></span>
                        <span>F</span>
                        </label>
                     </div>
                     <div class="col-lg-1 col-12">
                        <label class="containercheckmark">
                        <input type="checkbox" class="form-control" name="day_saturday" value="1" />
                        <span class="checkmark"></span>
                        <span>Sa</span>
                        </label>
                     </div>
                     <div class="col-lg-1 col-12">
                        <label class="containercheckmark">
                        <input type="checkbox" class="form-control" name="fld_day_sunday" value="1" />
                        <span class="checkmark"></span>
                        <span>Su</span>
                        </label>
                     </div>
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <label class="switch">
                        <input type="checkbox" checked="checked" name="fld_re_occur" value="1" />
                  ...
                  <div class="row ">
                     ...
                     <div class="col-lg-6 col-12">
                        <select class="form-control select inline" name="fld_content_type">
                           <option value="Memory Health">Memory Health</option>
                        </select>
                     </div>
                  </div>
                  <br>
                  <div class="row">
                     ...
                     <div class="col-lg-10 col-12">
                        <p class="formfield">
                           <textarea id="textarea" class="custom-file form-control mb-2" style="min-height: 140px;" rows="4" name="fld_about_class" required=""></textarea>
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-10 col-12">
                        <p class="formfield">
                           <textarea id="textarea" class="custom-file form-control mb-2" rows="3" style="min-height: 80px;" name="fld_equipment_require" required=""></textarea>
                  ...
                  <div class="row ">
                     ...
                     <div class="col-lg-7 col-12">
                        <div class="custom-file inline float-right mb-3">
                           ...
                           <input type="file" class="custom-file-input" name="fld_hero_image" id="fld_hero_image" accept="image/x-png,image/gif,image/jpeg" required="" style="opacity: 1;" />                           
                        </div>
                     </div>
                  </div>
                  <div class="row ">
                     ...
                     <div class="col-lg-7 col-12">
                        <div class="custom-file inline float-right mb-3">
                           ...
                           <input type="file" class="custom-file-input" name="fld_browser_image_1" id="fld_browser_image_1" accept="image/x-png,image/gif,image/jpeg" required="" style="opacity: 1;" />
                        </div>
                     </div>
                  </div>
                  <div class="row ">
                     ...
                     <div class="col-lg-7 col-12">
                        <div class="custom-file inline float-right mb-2">
                           ...
                           <input type="file" class="custom-file-input" name="fld_browser_image_2" id="fld_browser_image_2" accept="image/jpeg" required="" style="opacity: 1;" />
                        </div>
                     </div>
                  </div>
                  <div class="row mb-2">
                  ...
                  <div class="row ">
                     ...
                     <div class="col-lg-7 col-12">
                        <div class="custom-file inline float-right mb-2">
                           ...
                           <input type="file" class="custom-file-input" name="fld_video_clip" id="fld_video_clip" accept="video/*" required="" style="opacity: 1;" />
                        </div>
                     </div>
                  </div>
                  <div class="row mb-2">
